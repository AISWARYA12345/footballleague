...
$result = mysql_query("SELECT * from login where username='".$username."' and password='".$password."' and status='1'") or die(mysql_error());
$flag=0;
while($row = mysql_fetch_array($result))
  ...
  else if($flag==1 && $type=="league")
  echo "<script>location.href='leaguehome.php'</script>";
  else if($flag==1 && $type=="player")
 	header('location:playerhome.php');  
  else if($flag==1 && $type=="coach")
